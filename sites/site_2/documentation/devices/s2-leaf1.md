...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf2_Ethernet1 | *trunk | *2-4094 | *- | *['MLAG'] | 1 |
| Ethernet2 | S2-SPINE1_Ethernet2 | *trunk | *30 | *- | *- | 2 |
| Ethernet3 | S2-SPINE2_Ethernet2 | *trunk | *30 | *- | *- | 2 |
| Ethernet4 | s2-host1_eth1 | *access | *30 | *- | *- | 4 |
| Ethernet6 | MLAG_PEER_s2-leaf2_Ethernet6 | *trunk | *2-4094 | *- | *['MLAG'] | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_s2-leaf2_Po1 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
